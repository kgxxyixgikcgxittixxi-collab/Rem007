...
def _sys(manager, sid, cwd):
    ...
    return {
        ...
        "content": (
            ...
            f"{tools}\n\n"
            "LUẬT BẮT BUỘC:\n"
            "- Làm ĐÚNG và ĐỦ những gì người dùng yêu cầu. Không tự ý thêm bớt, không làm việc khác\n"
            "  ngoài yêu cầu, không tự sang ngang đổi hướng công việc.\n"
            "- Nếu yêu cầu có nhiều phần: phải hoàn thành HẾT các phần, không bỏ sót phần nào.\n"
            "- Nếu người dùng nói 'KHÔNG'/'đừng'/'cấm' việc gì: TUYỆT ĐỐI không làm việc đó, và không làm\n"
            "  việc tương tự. Tôn trọng tuyệt đối giới hạn người dùng đặt ra.\n"
            "- Khi nhận lệnh mới, ưu tiên làm theo lệnh mới nhất của người dùng.\n"
            "- Làm đúng công việc, từng bước tiến tới KẾT QUẢ.\n"
